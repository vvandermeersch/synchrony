...
% solstice timing in relation to GDD and optimal conditions for growth differs significantly between regions?
...
% + tracking the solstice could actually be more complex than tracking GDD (directly linked to metabolic processes)?
% + indeed, to detect solstice precisely, plants would need to detect not just the day length but the rate of change in day length (second derivative...) => tracking GDD is likely less complex and more directly beneficial for the plant
