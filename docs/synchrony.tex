...
\vspace*{-0.7cm}
\caption{\textbf{Solstice marks the optimal trade-off between environmental predictability and growth potential.}} %emw11Dec: Be sure this caption (1) very briefly gives the method and (2) stresses this as averaged (while the next shows the variability). 
...
We found the optimal period to be near the summer solstice in Europe (\Cref{fig:globaloptimality}). Solstice appears as a critical juncture for the optimization of both environmental predictability and growth potential.
...
It could act as a reliable marker for when a plant has likely accumulated the right amount of GDD. %emw11Dec: I don't love 'the right amount' ... we could maybe delete the sentence or change to: It could thus act as a reliable marker of each year's expected GDD before too late in the season. OR ... start a new paragraph as I suggest here ...
