...
\noindent Dear Editor, %emw19Jan -- add name. Also before I forget, I go by EM Wolkovich in publications. 

\vspace{0.25cm} %emw19Jan -- cover letter in very nice shape! I just made major edits to one paragraph; take or leave them. 

\noindent Please consider our paper, entitled ``Solstice optimizes thermal growing season'' for publication as a Brief Report in \emph{PNAS}. 
...
\noindent Both authors contributed to this work and approve this version for submission. The manuscript is 1400 words, with 17 references and 3 figures, and is not under consideration elsewhere. We hope you find it suitable for publication in \emph{PNAS}, and look forward to hearing from you. 
