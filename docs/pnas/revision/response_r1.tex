...
Thank you for this suggestion. We now explicitly that this hypothesis was proposed for temperate tree species (\href{file:synchrony_r1\#lintarget:temptree}{line \ref*{lin:temptree}}).\\
...
We are not sure of the reviewer's concerns regarding this sentence, but we have adjusted the paragraph it comes from to stress the relevance of soil moisture as well. \\ % line #
...
Sorry it was not clear. We now explicitly mention the temperature range in the text (\href{file:synchrony_r1\#lintarget:range}{line \ref*{lin:range}}):
\begin{quote}
