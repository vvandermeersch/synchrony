...
Thank you for this suggestion, which was also raised by Reviewer 1. We now clarify early in the Introduction that we focus on temperate latitudes in the Northern Hemisphere (\href{file:synchrony_r1\#lintarget:temptree}{lines \ref*{lin:temptree}} \& \href{file:synchrony_r1\#lintarget:north}{\ref*{lin:north}}). \\ % more LINE?
...
% ADD MENTION TO THE REPO AND THE CODE?
Additionally, we have posted all our code (LINK) and links to the public data so that others can remake this figure with varying GDD thresholds. \\
