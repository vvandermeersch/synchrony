...
\llabel{moist} Further, in many northern temperate latitudes, the growing season is likely constrained by moisture availability in addition to temperature \citep{Garonna2018}. % a bit 'comme un cheveu sur la soupe'
How stable solstice would be as a useful transition in a warmer and drier future climate is unknown \citep{Bonamour2019}.  
Fixed cues with warming could drive forest declines, with significant implications for carbon storage \citep{green2022limits}---raising important questions about the suitability for plants to rely on the summer solstice. % Alternative (Starting at 'further' to end of paragraph):  Further, as the growing season is likely to be increasingly constrained by moisture availability in many northern temperate latitudes with climate change \citep{Garonna2018}, how stable solstice will continue to be is a major open question. Fixed cues could drive forest declines, with significant implications for carbon storage \citep{green2022limits}---raising important questions about the suitability for trees to rely on the summer solstice in a warmer and drier future.
